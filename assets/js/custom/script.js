$(function(){
    ...
    sr.reveal('.main-title,.content-sep,.p,.menu-container,.content-heading,.desc,.h2,.home-page-owl,.footer-container .menu-item,.footer-container img,.land-details .span,.round-img-container,.contact-us-form,.map-container,.mission-desc .col-md-4', intro);
